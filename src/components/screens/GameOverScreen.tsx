  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-950 via-indigo-950 to-gray-950 flex flex-col items-center justify-center p-6 gap-6 text-center">
      <div>
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-red-400 mb-2">The Dragon Wins!</h1>
        <p className="text-purple-100 text-lg md:text-xl">Don't give up, <span className="text-amber-400 font-bold">{playerName}</span>!</p>
        <p className="text-purple-400 text-sm md:text-base mt-1">Every dragon master falls before they rise! 💪</p>
      </div>

      <div className="bg-purple-900/40 border border-purple-700/50 rounded-2xl p-6 md:p-8 w-full max-w-sm">
        <div className="text-purple-300 text-sm md:text-base mb-1">Score this run</div>
        <div className="text-6xl md:text-7xl font-extrabold text-red-400">{score}</div>
      </div>
